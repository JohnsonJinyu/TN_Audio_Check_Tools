              ...
              <div className="settings-update-header">
                ...
                <Space wrap>
                  ...
                  <Dropdown menu={{ items: [
                    ...
                    { key: 'mirror', label: '浏览器下载', disabled: !canOpenExternalDownload, onClick: handleOpenExternalDownload },
                ...
                <Alert
                  ...
                  description={
                    updateState?.externalDownloadUrl
                      ? `应用内下载会自动尝试多个下载源；如果当前网络下速度仍不理想，可从更多操作菜单选择浏览器下载 ${updateState?.assetName || '安装包'}。当前优先外部源：${updateState?.mirrorName || '备用下载源'}。`
                      : '如果应用内下载速度不理想，可从更多操作菜单选择浏览器下载，在浏览器中打开发布页。'
                  }
                />
              ) : null}
